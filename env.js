...
(function(global){
  ...
  //apiUrl = 'http://js.arcgis.com/3.25';
  apiUrl = 'http://10.90.128.167:8088/3.25';
  //////////////////////////////////////////////////////////////
  ...
  if (!apiUrl) {
    if (queryObject.apiurl) {
      ...
      apiUrl = 'http://js.arcgis.com/' + apiVersion;
      // 使用自己的arcgis_js_api部署
      // apiUrl = 'https://api.daoheit.com/arcgis_js_api/library/' + apiVersion;
    } else {
      var portalUrl = getPortalUrlFromLocation();
      console.log("erwin's code:" + portalUrl);
